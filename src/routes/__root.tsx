...
const THEME_INIT_SCRIPT = `(function(){try{var t=localStorage.getItem("Indigo.theme")||"dark";var d=t==="dark";var e=document.documentElement;e.classList.toggle("dark",d);e.style.colorScheme=d?"dark":"light";}catch(e){}})();`;
